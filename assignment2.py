...
image =cv2.imread('nobita.jpg')
image2 = cv2.imread('goku.jpg')
image3 = cv2.imread('mp.jpg')
image4 = cv2.imread('goku-super-saiyan-wallpaper.jpg')
image5 = cv2. imread('goku.jpg')
image6 = cv2. imread('nobita.jpg')
while True:
